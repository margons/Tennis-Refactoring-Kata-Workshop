...
public class TennisGameTest {
    ...
    @Test
    public void testScoreThirtyFifteen() throws Exception {
        TennisGame game = new TennisGame(PLAYER_ONE, PLAYER_TWO);
        ...
        String score = game.getScore();
        assertEquals(SCORE_THIRTY + "-" + SCORE_FIFTEEN, score);
    }

    @Test
    public void testScoreThirtyForty() throws Exception {
        TennisGame game = new TennisGame(PLAYER_ONE, PLAYER_TWO);
    ...
    @Test
    public void testScoreFortyFifteen() throws Exception {
        TennisGame game = new TennisGame(PLAYER_ONE, PLAYER_TWO);
        ...
        String score = game.getScore();
        assertEquals(SCORE_FORTY + "-" + SCORE_FIFTEEN, score);
    }

    @Test
    public void testScoreFortyThirty() throws Exception {
        TennisGame game = new TennisGame(PLAYER_ONE, PLAYER_TWO);
        ...
        String score = game.getScore();
        assertEquals(SCORE_FORTY + "-" + SCORE_THIRTY, score);
    }
}